...
function carregado(){    
    ...
    db.transaction(function(tx) {
       // tx.executeSql("DROP TABLE myTable" );
        tx.executeSql("CREATE TABLE IF NOT EXISTS myTable ( id INTEGER PRIMARY KEY,nome TEXT,senha TEXT, email TEXT, telefone TEXT)"
 

		
	);
/     //  tx.executeSql('INSERT INTO myTable ( nome,senha,email,telefone) VALUES ("a", "b", "c", "d")');
    });
